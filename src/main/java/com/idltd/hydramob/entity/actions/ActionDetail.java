package com.idltd.hydramob.entity.actions;
...
public class ActionDetail {
    ...
    @Column(name = "ACT_PLANE_START_DATE")
    public String act_plane_start_date;

    @Column(name = "ACT_PLANE_END_DATE")
    public String act_plane_end_date;
    ...
    @Column(name = "ACT_END_START_DATE")
    public String act_end_start_date;

    @Column(name = "ACT_END_END_DATE")
    public String act_end_end_date;
