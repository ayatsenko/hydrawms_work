...
@XmlRootElement(name = "СчетПоставщика", namespace="ExchangeCRM")
...
public class SupplierAccount {
    ...
    @XmlElement(name = "ДатаПоступленияДокументовСопровождения", namespace="ExchangeCRM")
    private String arrivalDocumentsDate;
    ...
    private List<Requests> buyerRequests;
    ...
    public String getArrivalDocumentsDate() {
        return arrivalDocumentsDate;
    }

    public void setArrivalDocumentsDate(String arrivalDocumentsDate) {
        this.arrivalDocumentsDate = arrivalDocumentsDate;
    }
    ...
    public List<Requests> getBuyerRequests() {
        return buyerRequests;
    }

    public void setBuyerRequests(List<Requests> buyerRequests) {
