package com.idltd.hydramob.controller.report_tms_trans_cities;
...
import com.idltd.hydramob.repository.report_tms_trans_cities.MenuReportTMSTransCitiesDetailRepository;
...
@RestController
@RequestMapping("/report_tms_trans_cities")
public class ReportTMSTransCitiesController {

    private User_ListRepository user_ListRepository;
    private User_Role_ListRepository user_Role_ListRepository;
    private MenuReportTMSTransCitiesDetailRepository menuReportTMSTransCitiesDetailRepository;
    ...
    public ReportTMSTransCitiesController(
            User_ListRepository user_ListRepository,
            User_Role_ListRepository user_Role_ListRepository,
            MenuReportTMSTransCitiesDetailRepository menuReportTMSTransCitiesDetailRepository,
        ...
        this.menuReportTMSTransCitiesDetailRepository = menuReportTMSTransCitiesDetailRepository;
    ...
    public ModelAndView index(
        ...
        mav.setViewName("report_tms_trans_cities/cover");
        return mav;
    }
    ...
    public JSONDatatable get_detail_table(
        ...
        if(start_date != null && end_date != null && req_cnt_id != null) {
            ...
            result.setData(menuReportTMSTransCitiesDetailRepository.queryGetRepTMSTransCitiesDetail(user_List.get(0).id, user_Role_List.get(0).role_id, StartResult, EndResult, req_cnt_id, req_user_id));
        }
        return result;
    }
}
