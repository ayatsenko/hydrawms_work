package com.idltd.hydramob.controller.report_tms_trans_corr;
...
import com.idltd.hydramob.repository.report_tms_trans_corr.MenuReportTMSTransCorrDetailRepository;
...
@RestController
@RequestMapping("/report_tms_trans_corr")
public class ReportTMSTransCorrController {

    private User_ListRepository user_ListRepository;
    private User_Role_ListRepository user_Role_ListRepository;
    private MenuReportTMSTransCorrDetailRepository menuReportTMSTransCorrDetailRepository;
    private TMS_Transport_Report_ListRepository tms_Transport_Report_ListRepository;
    public ReportTMSTransCorrController(
            User_ListRepository user_ListRepository,
            User_Role_ListRepository user_Role_ListRepository,
            MenuReportTMSTransCorrDetailRepository menuReportTMSTransCorrDetailRepository,
            TMS_Transport_Report_ListRepository tms_Transport_Report_ListRepository
    ) {
        this.user_ListRepository = user_ListRepository;
        this.user_Role_ListRepository = user_Role_ListRepository;
        this.menuReportTMSTransCorrDetailRepository = menuReportTMSTransCorrDetailRepository;
    ...
    public ModelAndView index(
        ...
        mav.setViewName("report_tms_trans_corr/cover");
        return mav;
    }
    ...
    public JSONDatatable get_detail_table(
        ...
        if(start_date != null && end_date != null && req_cnt_id != null) {
            ...
            result.setData(menuReportTMSTransCorrDetailRepository.queryGetRepTMSTransCorrDetail(user_List.get(0).id, user_Role_List.get(0).role_id, StartResult, EndResult, req_cnt_id));
        }
        return result;
    }
}
