package com.idltd.hydramob.controller.report_tms_trans_markup;
...
import com.idltd.hydramob.repository.report_tms_trans_markup.MenuReportTMSTransMarkupDetailRepository;
...
@RestController
@RequestMapping("/report_tms_trans_markup")
public class ReportTMSTransMarkupController {

    private User_ListRepository user_ListRepository;
    private User_Role_ListRepository user_Role_ListRepository;
    private MenuReportTMSTransMarkupDetailRepository menuReportTMSTransMarkupDetailRepository;
    ...
    public ReportTMSTransMarkupController(
            User_ListRepository user_ListRepository,
            User_Role_ListRepository user_Role_ListRepository,
            MenuReportTMSTransMarkupDetailRepository menuReportTMSTransMarkupDetailRepository,
        ...
        this.menuReportTMSTransMarkupDetailRepository = menuReportTMSTransMarkupDetailRepository;
    ...
    public ModelAndView index(
        ...
        mav.setViewName("report_tms_trans_markup/cover");
        return mav;
    }
    ...
    public JSONDatatable get_detail_table(
        ...
        if(start_date != null && end_date != null && req_cnt_id != null) {
            ...
            result.setData(menuReportTMSTransMarkupDetailRepository.queryGetRepTMSTransMarkupDetail(user_List.get(0).id, user_Role_List.get(0).role_id, StartResult, EndResult, req_cnt_id, req_user_id));
        }
        return result;
    }
}
